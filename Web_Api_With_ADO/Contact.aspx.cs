...
namespace Web_Api_With_ADO
{
    public partial class Contact : Page
    {
        ...
        protected void gdStudents_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if(e.CommandName.ToString() == "Delete")
            {
                ...
                try
                {
                    ...
                    if (StdID.Trim() != null)
                    {
                        cmd.Parameters.AddWithValue("@Id",Convert.ToInt32(StdID));
                    }
                    // Executing the SQL query  
                    cmd.CommandType = CommandType.StoredProcedure;
                    // Executing the SQL query  
            ...
            {
                string StdID = e.CommandArgument.ToString();
                Response.Redirect("EditData.aspx?SID="+StdID);
            }
        }

        protected void gdStudents_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
